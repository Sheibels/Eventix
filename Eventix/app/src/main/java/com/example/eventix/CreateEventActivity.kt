...
class CreateEventActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    private fun createEvent() {
        ...
        btnCreateEvent.text = "A criar evento..."
        ...
        db.collection("eventos")
            ...
            .addOnSuccessListener { documentReference ->
                ...
                showAlertDialog("Sucesso", "Evento criado com sucesso!") {
                    val intent = Intent(this, EventDetailsActivity::class.java)
            ...
            .addOnFailureListener { e ->
                Log.w(TAG, "Erro ao criar evento", e)
                btnCreateEvent.isEnabled = true
                btnCreateEvent.text = "CRIAR EVENTO"
                showAlertDialog("Erro", "Erro ao criar evento. Tente novamente.")
            }
    }
    ...
    private fun validateEventData(): Boolean {
        ...
        if (selectedServicesIds.isEmpty()) {
            showAlertDialog("Erro", "Deve selecionar pelo menos 1 serviço para criar o evento.")
            return false
        }
